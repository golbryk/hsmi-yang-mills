...
By the Markov property of the path integral: $T$ is a contraction
($\|T[f]\| \le \|[f]\|$) and self-adjoint ($\langle T[f],[g]\rangle
= \langle [f],T[g]\rangle$) on $\mathcal{H}_{\mathrm{phys}}$.
Hence $T = e^{-a_0 H}$ for a unique self-adjoint $H \ge 0$
(spectral theorem for bounded self-adjoint operators).
$H\Omega = 0$ since $T\Omega = \Omega$ (translation invariance of $d\mu_\beta$).
...
and ALL $t > 0$.  By the spectral representation \eqref{eq:S2_gap_bound}:
\[
