...
| File | Content | Status |
|------|---------|--------|
| `paper_Pi_v16.docx` | **Main paper** — Fisher zeros of two-plaquette SU(N), N odd; Theorem 2Seq, Lemma TSI | Current |
...
Omega-C v7: Single-plaquette spacing Δ = 2π/(N − t_vdm)
    |
Pi v16: Two-plaquette spacing ⟨Δ⟩ = π/2  [main result, N odd]
    |
    +-- Open: N even (different mechanism)
    +-- Open: n-plaquette (conjectured ⟨Δ⟩ = π/n)
    +-- Open: thermodynamic limit |Λ| → ∞
```
